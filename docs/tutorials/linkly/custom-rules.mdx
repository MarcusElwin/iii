---
title: "Custom redirect rules"
description: "Let customers attach a script that picks the redirect target, run it in an iii-sandbox on every request."
owner: "devrel"
type: "tutorial"
---
...
[A link-safety agent](/tutorials/linkly/safety-agent), an autonomous agent samples newly created links,
