---
title: "Ch. 7: Open it to users"
description: "Let customers attach a script that picks the redirect target, run it in a iii-sandbox on every request."
owner: "devrel"
type: "tutorial"
---
...
stdout. Build it up in pieces. Start a fresh sandbox for this call:
