---
title: "Observe the redirect path"
description: "Add logs and traces to Linkly's redirect path, then inspect them from the CLI and the console."
owner: "devrel"
type: "tutorial"
---
...
worker clears them. Next, in [Persist links](/tutorials/linkly/persistence), you move them into durable
storage.
