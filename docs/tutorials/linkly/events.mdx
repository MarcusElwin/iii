---
title: "React to clicks"
description: "Move click recording onto a queue, then broadcast link events to independent subscribers."
owner: "devrel"
type: "tutorial"
---
...
```bash
iii trigger database::query --json '{"db":"primary","sql":"SELECT day, count FROM daily_link_counts"}'
```
...
[Schedule and stream](/tutorials/linkly/scheduling-and-streams), you sweep expired links on a schedule
