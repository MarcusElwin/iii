...
// ephemeral microVM, never on the link-worker process. Returns the chosen URL,
...
worker.registerFunction(
  'http::create',
  async (req: ApiRequest<{ url?: string; code?: string; expires_at?: string }>): Promise<ApiResponse> => {
