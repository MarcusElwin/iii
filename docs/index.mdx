...
description: A next-generation backend system that collapses distributed software into three primitives — Worker, Trigger, Function — eliminating integration complexity and making software unreasonably simple to create, extend, and modify.
---
...
iii collapses distributed backend design into three primitives: **Worker**, **Trigger**, **Function**. Something hosts work, something causes it, something does it. Every capability — queues, cron, streaming, sandboxing, observability, agents, business logic, devices, UIs — is built from these three things.
...
| **Simple Primitives** | Collapse distributed backend design into a paradigm humans and agents can reason about. The primitives are small enough to hold in your head. |
