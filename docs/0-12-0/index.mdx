...
example the addition of an agentic harness includes a single integration point with your current
system along with the numerous downstream consumers of it.
